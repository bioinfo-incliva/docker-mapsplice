...
def filterbyannotation(in_fusion,
    ...
    SeparateNormalFromFusionJunc_cmd = [bin_dir + "SeparateNormalFromFusionJunc",
                                        ...
                                        filter_repeats_dir + "filter_repeats.txt.annot.strand.notmatch.fusion",#output_dir + "fusion.from.fusion",
                                        filter_repeats_dir + "normal.from.fusion",
                                        filter_repeats_dir + "circular_RNAs.txt"]
...
def extract_maxlen(log_file):
	...
	return (int(command[1]), read_format);
    else:
...
def main(argv=None):
	...
	(maxlen, format_flag) = extract_maxlen(logging_dir + "check_reads_format.log");
	...
	if do_fusion > 0:
		...
		filterbyannotation(output_dir + "fusions_candidates.txt",
		                   output_dir + "fusions_annotated.txt",
		                   gene_gtf_file,
		                   logging_dir)
