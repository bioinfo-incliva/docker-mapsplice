...
def main(argv=None):
	...
	copy_file(filtered_alignment_base + ".stat", output_dir + "normal_stat.txt");
	
	if do_fusion > 0:
	    copy_file(filtered_fusion_alignment_base + ".stat", output_dir + "fusion_stat.txt");
	    
	    if is_paired > 0:
		copy_file(filtered_fusion_alignment_base + ".ori.junc.fusion.encompass.no.compass", output_dir + "fusions.txt");
	    else:
		copy_file(filtered_fusion_alignment_base + ".ori.junc.fusion.encompass.no.compass", output_dir + "fusions.txt");
