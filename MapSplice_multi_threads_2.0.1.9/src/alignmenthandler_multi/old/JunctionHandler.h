...
public:
	...
	void UpdateJuncTable(const string& chromname, size_t combined_offset, size_t prefixlen, size_t suffixlen, size_t fusion_prefixlen, size_t fusion_suffixlen, size_t start, size_t end, const string& ins_str, const SamRec& samrec, size_t sam_count, bool is_fusion = false);
