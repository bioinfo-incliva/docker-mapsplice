...
int main(int argc, const char** argv)
{
	...
	ofs << "total_reads\t"<< paired + single + fusion_paired + unmapped << endl;
	...
	ofs << "paired_reads\t"<< paired << endl;

	ofs << "single_reads\t"<< single << endl;

	ofs << "fusion_paired_reads\t"<< fusion_paired << endl;

	ofs << endl;

	ofs << "By mapping uniqueness"<<endl;

	ofs << "multiple\t" << multiple << endl;

	ofs << "unique\t" << unique << endl;

	ofs << "unmapped_reads\t"<< unmapped << endl;
	...
	ofs << "splice_junctions"<<endl;

	ofs << "splice_junction_canonical\t"<< normal_junc_canonical<< endl;

	ofs << "splice_junction_semi_canonical\t"<< normal_junc_semi_canonical<< endl;

	ofs << "splice_junction_non_canonical\t"<< normal_junc_non_canonical<< endl;

	ofs << endl;

	ofs << "fusion_junctions"<<endl;

	ofs << "fusion_junction_canonical\t"<< fusion_junc_canonical<< endl;

	ofs << "fusion_junction_semi_canonical\t"<< fusion_junc_semi_canonical<< endl;

	ofs << "fusion_junction_non_canonical\t"<< fusion_junc_non_canonical<< endl;

	ofs << endl;

	ofs << "filtered_fusions"<<endl;
